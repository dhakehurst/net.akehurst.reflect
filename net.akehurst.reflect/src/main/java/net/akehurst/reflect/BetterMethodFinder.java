...
public final class BetterMethodFinder {
  ...
  public Constructor findConstructor(Object[] parameterValues) throws NoSuchMethodException  {
	  return findConstructor(BetterMethodFinder.getParameterTypesFrom(parameterValues));
  }
  /**
  ...
  throws NoSuchMethodException {
    ...
    if (matchingMembers.isEmpty())
      throw new NoSuchMethodException(
        "no member in " + clazz.getName() + " matching args "+Arrays.asList(parameterTypes));
  ...
  public Method findMethod(String methodName, Object[] parameterValues) throws NoSuchMethodException  {
	  return findMethod(methodName, BetterMethodFinder.getParameterTypesFrom(parameterValues));
  }
